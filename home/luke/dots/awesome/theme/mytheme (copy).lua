-----------------------------------------
-- Not quite the default awesome theme --
-----------------------------------------
...
-- theme.font          = "Caskaydia Cove Nerd Font Mono 11"

theme.font          = "Cantarell Bold 11"

theme.bg_normal     = colors.bg .. "00"
theme.bg_focus      = colors.fg .. "BF"
theme.bg_urgent     = colors.color4 .. "80"
theme.bg_minimize   = colors.bg .. "00"
theme.bg_systray    = theme.bg_normal 

theme.fg_normal     = colors.fg 
theme.fg_focus      = colors.bg  
theme.fg_urgent     = colors.fg
theme.fg_minimize   = colors.fg .. "80"
